...
export const world2: LevelDef[] = [
  // L7 — MOVING TRAPS: four piston crushers drop on staggered, faster beats, then a gap.
  {
    ...
    exit: { x: 28, y: 5 },
    movingWalls: [
      { id: "mw1", x: 6, y: 0, w: 1, h: 4, axis: "y", range: 3, speed: 1.1, phase: 0 },
      { id: "mw2", x: 9, y: 0, w: 1, h: 4, axis: "y", range: 3, speed: 1.1, phase: 0.33 },
      { id: "mw3", x: 12, y: 0, w: 1, h: 4, axis: "y", range: 3, speed: 1.1, phase: 0.66 },
      { id: "mw4", x: 21, y: 0, w: 1, h: 4, axis: "y", range: 3, speed: 1.1, phase: 0.15 },
    ],
